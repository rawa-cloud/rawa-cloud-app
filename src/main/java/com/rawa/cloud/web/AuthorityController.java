...
public class AuthorityController {
    ...
    @ApiOperation("更新")
    @PatchMapping("/{id}")
    public JsonResult patch(@PathVariable  Long id, Boolean isUser,  @Valid @RequestBody AuthorityPatchModel model, BindingResult result) {
        ValidationHelper.validate(result);
    ...
    @ApiOperation("删除")
    @DeleteMapping("/{id}")
    public JsonResult delete(@PathVariable Long id, boolean isUser) {
        authorityService.delete(id, isUser);
        return JsonResult.success(null);
    }
